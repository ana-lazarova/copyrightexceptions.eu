---
title: "§ 13a of the Copyright Act"
date: 2023-06-06 
draft: false
weight: 12
exceptions:
...
- DK
score: 1
description: "This exception allows for the reproduction and making available for illustration in teaching, under the responsibility of an educational institution on premises or via secure digital environments, provided that the use is non-commercial. The exception is remunerated and only applies if no suitable extended collective licensing scheme exists." 
beneficiaries:
- any user (under the responsibility of an educational institution on premises or via secure digital environment)
purposes: 
