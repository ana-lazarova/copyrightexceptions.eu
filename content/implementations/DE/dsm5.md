---
title: "§60a Urheberrechtsgesetz – UrhG"
date: 2021-06-21
draft: false
weight: 12
exceptions:
...
- DE
score: 2
description: "Germany has one copyright exception for illustration for teaching in educational establishments (§60a), which covers the uses protected by Article 5 of the DSM Directive, but remote uses are subject to fewer conditions. This exception applies to computer programs (§69d(5)), albeit with specific conditions. It also applies to other protected subject matter (§83, §85(4), §87(4), §87c(1)3 and (4), §87i, §94(4)). " 
beneficiaries:
- teachers and participants at the respective event
- teachers and examiners at the same educational establishment
- third persons insofar as this serves the presentation of lessons or lectures or the results of tuition or training or learning outcomes at the educational establishment
purposes: 
...
There are also provisions stating that the exceptions to copyright apply mutatis mutandis to performances (§83), phonograms (§85(4)), broadcasts (§87(4)), press publications (§87i) and film fixations (§94). <br />
The law states that the rights holder may not rely on agreements that restrict or prohibit permitted uses under these exceptions to the detriment of the users. The safeguard against technological protection measures, which implements Article 7(2) of the CDSM Directive, covers these exceptions."
